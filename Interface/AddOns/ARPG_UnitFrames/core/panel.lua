...
function resetPoweOrb()
	panel.savePowerOrbModelEnable(true)
	--update orb view
...
panel:SetScript("OnEvent", function(self,event)
	...
	if event == "PLAYER_ENTERING_WORLD" then
		panel.savePowerOrbModelEnable(false)
		--update orb view
		panel.updatePowerOrbModelEnable()
		--update the panel view, other panels need to be shown / hidden
		panel.updateElementPowerOrbModelEnable()
...
local createBottomButtonHealthOrbSave = function(parent)
	...
	StaticPopupDialogs["ARPG_UNITFRAMES_HEALTHORB_SAVE"] = {
	...
	button:HookScript("OnClick", function()
		StaticPopup_Show("ARPG_UNITFRAMES_HEALTHORB_SAVE")
	end)
	button:SetScript("OnEnter", function(self)
		GameTooltip:SetOwner(self, "ANCHOR_TOP")
...
local createBottomButtonPowerOrbSave = function(parent)
	--the save button needs a popup with an editbox
	StaticPopupDialogs["ARPG_UNITFRAMES_POWERORB_SAVE"] = {
		text = "Enter a name for your template:",
		button1 = ACCEPT,
		button2 = CANCEL,
		hasEditBox = 1,
	...
	button:HookScript("OnClick", function()
		StaticPopup_Show("ARPG_UNITFRAMES_POWERORB_SAVE")
	end)
	button:SetScript("OnEnter", function(self)
		GameTooltip:SetOwner(self, "ANCHOR_TOP")

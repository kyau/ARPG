  ...
  func.createAuraIcon = function(icons, button)
    ...
    button.overlay:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\gloss")
    ...
    back:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\simplesquare_glow")
  ...
  func.createAltPowerBar = function(self,name)
    ...
    t:SetSize(64*num,64)
    t:SetPoint("LEFT",0,0)
    t:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_back")
    bar.back = t
    ...
    t:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_highlight")
  ...
  func.createDebuffGlow = function(self)
    ...
    if self.cfg.style == "target" then
      t:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\target_debuffglow")
    else
      t:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\targettarget_debuffglow")
    end
    t:SetAllPoints(self)
    t:SetBlendMode("BLEND")
  ...
  func.createPortrait = function(self)
    ...
    t:SetAllPoints(back)
    t:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\portrait_back")
    ...
    if self.cfg.portrait.use3D then
      ...
      border:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\portrait_border")
      ...
      gloss:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\portrait_gloss")
  ...
  func.createStandAlonePortrait = function(self)
    ...
    if self.cfg.style == "player" then
      fname = "ARPG_UnitFramesPlayerPortrait"
    elseif self.cfg.style == "target" then
      fname = "ARPG_UnitFramesTargetPortrait"
    end
  ...
  func.createCastbar = function(f)
    ...
    tinsert(ARPG_UnitFrames_Bars,c:GetName())
    ...
    c.background:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\castbar")
    ...
    c.glow:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\castbar_glow")
    c.glow:SetAllPoints(c.background)
    c.glow:SetVertexColor(0,0,0,1)

    c.highlight = c:CreateTexture(nil,"OVERLAY",nil,-3)
    c.highlight:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\castbar_highlight")

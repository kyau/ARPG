...
bars.createExpBar = function(self)
	...
	local f = CreateFrame("StatusBar","ARPG_UnitFramesExpBar",self)
...
bars.createRepBar = function(self)
	...
	local f = CreateFrame("StatusBar","ARPG_UnitFramesRepBar",self)
	f:SetFrameStrata("BACKGROUND")
	f:SetFrameLevel(2)
	f:SetSize(w,h)
	f:SetPoint(cfg.pos.a1, cfg.pos.af, cfg.pos.a2, cfg.pos.x, cfg.pos.y)
...
--create mage arcane charges bar
bars.createArcaneChargeBar = function(self)
	local ACharges = {}

	local t
	local bar = CreateFrame("Frame","ARPG_UnitFramesComboPoints",self)
	local w = 64*(6)
	local h = 64
	--bar:SetPoint("CENTER", UIParent, "CENTER", 0, 0)
	bar:SetPoint(self.cfg.arcanecharge.pos.a1,self.cfg.arcanecharge.pos.af,self.cfg.arcanecharge.pos.a2,self.cfg.arcanecharge.pos.x,self.cfg.arcanecharge.pos.y)
	bar:SetWidth(w)
	bar:SetHeight(h)
	bar:SetScale(self.cfg.arcanecharge.scale)

	--color
	bar.color = self.cfg.arcanecharge.color

	--left edge
	t = bar:CreateTexture(nil,"BACKGROUND",nil,-8)
	t:SetSize(64,64)
	t:SetPoint("LEFT",0,0)
	t:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_left")
	bar.leftEdge = t
	...
	t:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_right")
	bar.rightEdge = t
	...
	for i = 1, 4 do
		...
		orb.barBg:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_bar_bg")
		...
		orb.bg:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_orb_bg")
		...
		orb.fill:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_orb_fill1")
		...
		orb.border:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_orb_border")
		...
		orb.glow:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_orb_glow")
		...
		orb.highlight:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_orb_highlight")

	end

	--func.applyDragFunctionality(bar)
	--combat fading
	--if self.cfg.arcanecharge.combat.enable then
		--rCombatFrameFader(bar, self.cfg.arcanecharge.combat.fadeIn, self.cfg.arcanecharge.combat.fadeOut) --frame, buttonList, fadeIn, fadeOut
	--end
	self.ArcaneBar = bar
	--[[]
	for index = 1, 4 do
		...
		ACharge:SetPoint('BOTTOM', "UIParent", 'BOTTOM', index * ACharge:GetWidth() - 96, 180)
...
bars.createShadowOrbPowerBar = function(self)
	...
	local t
	local bar = CreateFrame("Frame","ARPG_UnitFramesShadowOrbPower",self)
	bar.maxOrbs = 5
...
bars.createHarmonyPowerBar = function(self)
	...
	local t
	local bar = CreateFrame("Frame","ARPG_UnitFramesHarmonyPower",self)
	bar.maxOrbs = 6
	local w = 64*(bar.maxOrbs+2) --create the bar for
	local h = 64
	--bar:SetPoint("CENTER", UIParent, "CENTER", 0, 0)
...
bars.createHolyPowerBar = function(self)
	...
	local t
	local bar = CreateFrame("Frame","ARPG_UnitFramesHolyPower",self)
	bar.maxOrbs = 5
	local w = 64*(bar.maxOrbs+2) --create the bar for
	local h = 64
	--bar:SetPoint("CENTER", UIParent, "CENTER", 0, 0)
...
bars.createBurningEmberPowerBar = function(self)
	...
	local t
	local bar = CreateFrame("Frame","ARPG_UnitFramesBurningEmberPower",self)
	bar.maxOrbs = 4
	local w = 64*(bar.maxOrbs+2) --create the bar for
	local h = 64
	--bar:SetPoint("CENTER", UIParent, "CENTER", 0, 0)
	...
	for i = 1, bar.maxOrbs do
		...
		orb.bg:SetSize(128*orbSizeMultiplier,128*orbSizeMultiplier)
		orb.bg:SetPoint("CENTER")
		orb.bg:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_pot_bg")
		orb.bg:SetAlpha(0.7)

		--orb filling
		local fill = orb:CreateTexture(nil,"BACKGROUND",nil,-6)
		fill:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_pot_fill1")
		...
		orb.border:SetSize(128*orbSizeMultiplier,128*orbSizeMultiplier)
		orb.border:SetPoint("CENTER")
		orb.border:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_pot_border")
		...
		orb.glow:SetSize(128*orbSizeMultiplier,128*orbSizeMultiplier)
		orb.glow:SetPoint("CENTER")
		orb.glow:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_pot_glow")
		...
		orb.highlight:SetSize(128*orbSizeMultiplier,128*orbSizeMultiplier)
		orb.highlight:SetPoint("CENTER")
		orb.highlight:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_pot_highlight")
...
bars.createSoulShardPowerBar = function(self)
	...
	local t
	local bar = CreateFrame("Frame","ARPG_UnitFramesSoulShardPower",self)
	bar.maxOrbs = 4
	local w = 64*(bar.maxOrbs+2) --create the bar for
	local h = 64
	--bar:SetPoint("CENTER", UIParent, "CENTER", 0, 0)
	...
	for i = 1, bar.maxOrbs do
		...
		orb.bg:SetSize(128*orbSizeMultiplier,128*orbSizeMultiplier)
		orb.bg:SetPoint("CENTER")
		orb.bg:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_gem_bg")

		--orb filling
		orb.fill = orb:CreateTexture(nil,"BACKGROUND",nil,-6)
		orb.fill:SetSize(128*orbSizeMultiplier,128*orbSizeMultiplier)
		orb.fill:SetPoint("CENTER")
		orb.fill:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_gem_fill1")
		...
		orb.border:SetSize(128*orbSizeMultiplier,128*orbSizeMultiplier)
		orb.border:SetPoint("CENTER")
		orb.border:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_gem_border")

		--orb glow
		orb.glow = orb:CreateTexture(nil,"BACKGROUND",nil,-4)
		orb.glow:SetSize(128*orbSizeMultiplier,128*orbSizeMultiplier)
		orb.glow:SetPoint("CENTER")
		orb.glow:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_gem_glow")
		...
		orb.highlight:SetSize(128*orbSizeMultiplier,128*orbSizeMultiplier)
		orb.highlight:SetPoint("CENTER")
		orb.highlight:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_gem_highlight")
...
bars.createDemonicFuryPowerBar = function(self)
	...
	sb:SetStatusBarTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\demonic_fury_statusbar")
	...
	t:SetAllPoints(sb)
	t:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\demonic_fury_statusbar")
	...
	t:SetAllPoints(bar)
	t:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\demonic_fury_border")
	sb.border = t

	local t = border:CreateTexture(nil,"BACKGROUND",nil,-7)
	t:SetSize(512,64)
	t:SetPoint("CENTER")
	t:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\demonic_fury_glow")
...
bars.createRuneBar = function(self)
	...
	local t
	local bar = CreateFrame("Frame","ARPG_UnitFramesRuneBar",self)
	bar.maxOrbs = 6
	local w = 64*(bar.maxOrbs+2) --create the bar for
	local h = 64
	...
	for i = 1, bar.maxOrbs do
		...
		fill:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\combo_orb_fill64_1")
...
bars.createEclipseBar = function(self)
	...
	local bar = CreateFrame("Frame","ARPG_UnitFramesEclipsePower",self)
	...
	bg:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\demonic_fury_statusbar")
	...
	fill:SetTexture("Interface\\AddOns\\ARPG\\Media\\Textures\\UnitFrames\\demonic_fury_statusbar")

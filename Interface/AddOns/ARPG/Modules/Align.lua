...
local linesT = {}
local linesB = {}
r1 = CreateFrame("Frame","ARPGAlignY",UIParent)
...
local r2 = CreateFrame("Frame","ARPGAlignX",r1)
...
function SlashCmdList.ALIGN(msg, editbox)
	if (msg) and (type(tonumber(msg))=="number") then
		if (tonumber(msg)<=4) then
			print("|cff69ccf0Align|r: Please enter a number at least 5 or larger.")
		else
